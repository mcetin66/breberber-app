...
import { X, Clock, User, Scissors, DollarSign, Calendar as CalendarIcon, Phone } from 'lucide-react-native';
...
export const AppointmentDetailModal = ({ visible, appointment, onClose }: AppointmentDetailModalProps) => {
                    ...
                    <View className="p-5 gap-4">
                        ...
                        <View className="flex-row items-center gap-3 bg-white/5 p-3 rounded-xl border border-white/5">
                            ...
                            <View className="flex-1">
                                ...
                                {/* If we had phone number, show it here */}
