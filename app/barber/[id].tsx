...
import { View, Text, Image, ScrollView, Pressable, ActivityIndicator, ImageBackground, Dimensions } from 'react-native';
...
export default function BarberDetailScreen() {
    ...
    console.log('--- BARBER DETAIL SCREEN MOUNTED ---', { id });
    ...
    return (
        <View className="flex-1 bg-background-light dark:bg-background-dark">
            <ScrollView className="flex-1" showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 120 }}>
                ...
                {/* Main Content Card */}
                <View className="-mt-6 rounded-t-[2rem] bg-background-light dark:bg-background-dark px-4 pt-8 flex-1">

                    {/* Info Grid */}
                    <View className="flex-row gap-3 mb-8">
                        <View className="flex-1 bg-white dark:bg-[#1a1a1a] p-4 rounded-xl border border-gray-100 dark:border-white/5 shadow-sm">
                            <View className="flex-row items-center gap-2 mb-1">
                                <MaterialIcons name="schedule" size={20} color={COLORS.primary.DEFAULT} />
                                <Text className="text-gray-900 dark:text-white font-bold text-sm">Hours</Text>
                            </View>
                            <Text className="text-gray-500 dark:text-gray-400 text-xs">Close at 9:00 PM</Text>
                        </View>
                        <View className="flex-1 bg-white dark:bg-[#1a1a1a] p-4 rounded-xl border border-gray-100 dark:border-white/5 shadow-sm">
                            <View className="flex-row items-center gap-2 mb-1">
                                <MaterialIcons name="directions-car" size={20} color={COLORS.primary.DEFAULT} />
                                <Text className="text-gray-900 dark:text-white font-bold text-sm">Distance</Text>
                            </View>
